...
const FramingBlogPost = (): ReactElement => (
  <>
    <Head>
    ...
    <div className="bg-slate-50 min-h-screen">
      ...
      <div className="text-lg px-36 pb-4">
        - framing everything as a challenge to strengthen me. - everything is a
        dopamine detox. - every time i have a choice between comfort and
        discomfort, i frame it as a challenge.
      </div>
...
export default FramingBlogPost;
